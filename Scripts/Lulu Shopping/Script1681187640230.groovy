...
Mobile.tap(findTestObject('Final Project/ButtonSKIP'), 0)

Mobile.tap(findTestObject('Final Project/android.widget.ImageView (5)'), 0)

Mobile.tap(findTestObject('Final Project/android.widget.Button - Continue (1)'), 0)

Mobile.tap(findTestObject('Final Project/android.widget.Button - Get Started'), 0)

Mobile.tap(findTestObject('Final Project/android.widget.TextView - Skip'), 0)

Mobile.tap(findTestObject('Final Project/android.widget.TextView - Store Pickup'), 0)

Mobile.tap(findTestObject('Final Project/android.widget.TextView - Lulu Hypermarket, Shati, Dammam'), 0)
...
Mobile.tap(findTestObject('Object Repository/Final Project/android.widget.Button - Add To Cart'), 0)

Mobile.tap(findTestObject('Object Repository/Final Project/android.widget.Button'), 0)
...
Mobile.tap(findTestObject('Object Repository/Final Project/android.widget.Button (1)'), 0)
...
Mobile.tap(findTestObject('Object Repository/Final Project/android.widget.Button - Go To Cart'), 0)
